                        ...
                        <div class="col product-item">
                            <div class="card h-100 product-card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-primary fw-bold fs-5 mb-2">{{ number_format($product->price, 0, ',', ' ') }} FCFA</p>
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <div class="input-group input-group-sm w-50">
                                            <input type="number" class="form-control quantity-input text-center" value="1" min="1" max="{{ $product->quantity }}">
