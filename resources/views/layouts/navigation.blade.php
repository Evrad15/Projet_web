                ...
                <div x-data="{ dropOpen: false }" class="relative">
                    ...
                    <div x-show="dropOpen"
                        ...
                        <div class="dropdown-header">
                            <p style="font-size:0.875rem; font-weight:600; color:#111827; margin:0 0 2px;">{{ Auth::user()->name }}</p>
                            <p style="font-size:0.75rem; color:#9ca3af; margin:0;">{{ Auth::user()->email }}</p>
                        </div>
    ...
    <div x-show="open"
        ...
        <div class="nav-root border-t border-gray-100 px-4 pt-3 pb-4">
            <div class="flex items-center gap-3 mb-3 px-2">
                ...
                <div>
                    <p style="font-size:0.875rem; font-weight:600; color:#111827; margin:0;">{{ Auth::user()->name }}</p>
                    <p style="font-size:0.75rem; color:#9ca3af; margin:0;">{{ Auth::user()->email }}</p>
                </div>
            </div>
