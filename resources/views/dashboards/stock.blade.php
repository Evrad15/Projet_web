...
<div class="container py-4">
    ...
    <div class="row g-3 mb-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">{{ number_format($stats['stock_value'], 2) }} FCFA</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm {{ $stats['low_stock'] > 0 ? 'bg-danger-subtle' : '' }}">
                <div class="card-body d-flex align-items-center">
                    <div class="flex-shrink-0 {{ $stats['low_stock'] > 0 ? 'bg-danger text-white' : 'bg-secondary-subtle text-secondary' }} p-3 rounded-3 me-3">
    ...
    <div class="d-flex justify-content-end mb-4">
        <form method="GET" action="{{ route('dashboard.stock') }}" class="d-flex gap-2 align-items-center">
