        ...
        <div class="row g-3 align-items-center">
            <div class="col-md-5">
                <form method="GET" action="{{ route('supplier.orders') }}" class="position-relative">
                    ...
                    <input type="text" name="search" class="form-control ps-5 py-2 bg-light border-0" placeholder="Rechercher un produit..." value="{{ request('search') }}">
                </form>
            </div>
            <div class="col-md-3">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><i class="bi bi-calendar-event me-2 text-muted"></i>{{ \Carbon\Carbon::parse($sale->created_at)->format('d/m/Y') }}</td>
                        <td><i class="bi bi-truck me-2 text-muted"></i>{{ \Carbon\Carbon::parse($sale->delivery_date ?? now())->format('d/m/Y') }}</td>
                        <td>
                            @php
                        ...
                        <td class="text-end pe-4 no-print">
                            <button class="btn btn-sm btn-outline-primary rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#orderModal{{ $sale->id }}">
                                <i class="bi bi-eye"></i>
                            </button>
