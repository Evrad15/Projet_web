        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1 space-y-6">
                <div class="p-6 bg-white shadow-xl rounded-2xl border border-gray-100 text-center">
                    ...
                    <p class="text-indigo-600 font-medium mt-2"><?php echo e($user->phone ?? 'Pas de numéro'); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mopao\Application_Web_de_gestion_des_ventes_et_inventaire\resources\views/profile/edit.blade.php ENDPATH**/ ?>