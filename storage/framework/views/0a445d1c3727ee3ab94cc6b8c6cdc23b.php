...
<div class="d-flex">
    <!-- SIDEBAR -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'sales_manager'): ?>
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-white border-end" style="width: 260px; min-height: calc(100vh - 65px);">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item mb-1">
                <a href="<?php echo e(route('clients.index')); ?>" class="nav-link active fw-bold">
    ...
    <div class="flex-grow-1 p-4" style="background-color: #f8f9fa;">
        ...
        <form action="<?php echo e(route('clients.index')); ?>" method="GET" class="mb-4 d-flex justify-content-end">
            <div class="input-group" style="max-width: 300px;">
                ...
                <a href="<?php echo e(route('clients.index')); ?>" class="btn btn-secondary">Réinitialiser</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </form>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4 fw-bold"><?php echo e($client->name); ?></td>
                                <td><?php echo e($client->email); ?></td>
                                <td><?php echo e($client->phone ?? '-'); ?></td>
                                <td><?php echo e(Str::limit($client->address, 40) ?? '-'); ?></td>
                                <td class="text-end pe-4">
                                    <a href="<?php echo e(route('clients.show', $client->id)); ?>" class="btn btn-sm btn-outline-primary rounded-circle me-1" title="Voir">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('clients.edit', $client->id)); ?>" class="btn btn-sm btn-outline-secondary rounded-circle me-1" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="<?php echo e(route('clients.destroy', $client->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Voulez-vous vraiment supprimer ce client ?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mopao\Application_Web_de_gestion_des_ventes_et_inventaire\resources\views/clients/index.blade.php ENDPATH**/ ?>