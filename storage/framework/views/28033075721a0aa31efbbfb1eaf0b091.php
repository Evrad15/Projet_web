...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <div>
            <h2 class="fw-bold mb-1">Documents de Vente #<?php echo e($sale->id); ?></h2>
            <p class="text-muted">Générés le <?php echo e($sale->created_at->format('d/m/Y à H:i')); ?></p>
        </div>
        <div>
            <?php
            $dashboardRoute = auth()->user()->role === 'sales_employee' ? 'dashboard.sales_employee' : 'sales.index';
            ?>
            <a href="<?php echo e(route($dashboardRoute)); ?>" class="btn btn-secondary">
                ...
                <div class="card-body d-flex justify-content-center bg-secondary bg-opacity-10">
                    <div id="receipt-area" class="bg-white p-3 shadow-sm" style="width: 80mm; min-height: 100mm; font-family: 'Courier New', Courier, monospace; font-size: 12px;">
                        <div class="text-center mb-3">
                            <h5 class="fw-bold mb-1"><?php echo e(config('app.name')); ?></h5>
                        ...
                        <div class="mb-2">
                            <span class="fw-bold">Ticket #<?php echo e($sale->id); ?></span><br>
                            <span>Date: <?php echo e($sale->created_at->format('d/m/Y H:i')); ?></span><br>
                            <span>Client: <?php echo e($sale->client->name); ?></span>
                        </div>
                        <hr class="border-dark border-dashed">
                        <table class="table table-borderless table-sm mb-0" style="font-size: 12px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-0"><?php echo e(Str::limit($item->product->name, 15)); ?></td>
                                    <td class="text-center">x<?php echo e($item->quantity); ?></td>
                                    <td class="text-end pe-0"><?php echo e(number_format($item->price * $item->quantity, 0, ',', ' ')); ?></td>
                                </tr>
                        ...
                        <div class="d-flex justify-content-between">
                            <span>Payé</span>
                            <span><?php echo e(number_format($sale->paid_amount ?? 0, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                        <?php $balance = $sale->total - ($sale->paid_amount ?? 0); ?>
                        ...
                        <div class="d-flex justify-content-between fw-bold fs-6" style="color: #dc3545;">
                            ...
                            <span><?php echo e(number_format($balance, 0, ',', ' ')); ?> FCFA</span>
                        </div>
                    ...
                    <div id="invoice-area" class="bg-white p-4 shadow-sm" style="width: 210mm; min-height: 297mm; margin: auto;">
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                ...
                                <p class="mb-0 fw-bold fs-5">N° FAC-<?php echo e($sale->id); ?></p>
                                <p class="text-muted">Date: <?php echo e($sale->created_at->format('d/m/Y H:i')); ?></p>
                            </div>
                            <div class="col-6 text-end">
                                <h4 class="fw-bold"><?php echo e(config('app.name')); ?></h4>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="border p-4 rounded">
                                    ...
                                    <h5 class="fw-bold mb-1"><?php echo e($sale->client->name); ?></h5>
                                    <p class="mb-0"><?php echo e($sale->client->email ?? ''); ?></p>
                                    <p class="mb-0"><?php echo e($sale->client->address ?? 'Adresse non renseignée'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered table-sm mb-4">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-end fw-bold fs-5 pt-3"><?php echo e(number_format($sale->total, 0, ',', ' ')); ?> FCFA</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-bold fs-4 text-primary pt-2"><?php echo e(number_format($sale->total, 0, ',', ' ')); ?> FCFA</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-end text-uppercase pt-3">Montant déjà versé</td>
                                    <td class="text-end fs-5 pt-3 text-success"><?php echo e(number_format($sale->paid_amount ?? 0, 0, ',', ' ')); ?> FCFA</td>
                                </tr>
                                <?php $balance = $sale->total - ($sale->paid_amount ?? 0); ?>
                                <tr class="table-light">
                                    <td colspan="3" class="text-end fw-bold text-uppercase pt-2">Solde à Payer</td>
                                    <td class="text-end fw-bold fs-4 pt-2 <?php echo e($balance > 0 ? 'text-danger' : 'text-success'); ?>"><?php echo e(number_format($balance, 0, ',', ' ')); ?> FCFA</td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="text-center pb-4 mt-5">
                            ...
                            <p class="small text-muted"><?php echo e(config('app.name')); ?> - Gestion Commerciale</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="delivery-note-area" class="bg-white p-5 shadow-sm" style="width: 210mm; min-height: 297mm; margin: auto;">
                        ...
                        <div class="row mb-5">
                            <div class="col-6">
                                ...
                                <p class="mb-0">Réf: <span class="fw-bold text-dark">BL-<?php echo e($sale->created_at->format('Ymd')); ?>-<?php echo e($sale->id); ?></span></p>
                                <p class="text-muted small">Date: <?php echo e($sale->created_at->format('d/m/Y')); ?></p>
                            </div>
                            <div class="col-6 text-end">
                                <h4 class="fw-bold"><?php echo e(config('app.name')); ?></h4>
                        ...
                        <div class="row mb-5">
                            <div class="col-6">
                                <div class="border p-3 rounded">
                                    ...
                                    <h5 class="fw-bold mb-1"><?php echo e($sale->client->name); ?></h5>
                                    <p class="mb-0 small"><?php echo e($sale->client->phone ?? 'Tél: N/A'); ?></p>
                                    <p class="mb-0 small"><?php echo e($sale->client->email ?? ''); ?></p>
                                    <p class="mb-0 small"><?php echo e($sale->client->address ?? ''); ?></p>
                                </div>
                            </div>
                            <div class="col-6 text-end">
                                <div class="p-3">
                                    <h6 class="text-uppercase text-muted small fw-bold mb-2">Vendeur</h6>
                                    <p class="fw-bold mb-0"><?php echo e($sale->sales_employee ? $sale->sales_employee->name : 'Administrateur'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered mb-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($item->product->name); ?></td>
                                    <td class="text-center fw-bold fs-5"><?php echo e($item->quantity); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mopao\Application_Web_de_gestion_des_ventes_et_inventaire\resources\views/sales/print.blade.php ENDPATH**/ ?>