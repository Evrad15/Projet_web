...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600"><?php echo e(__('Se souvenir de moi')); ?></span>
            </label>
        </div>-->
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-center mt-6 pt-4 border-t border-gray-100">
            <p class="text-sm text-gray-600">
                <?php echo e(__("Nouveau client ?")); ?>

                <a class="ml-1 font-bold text-indigo-600 hover:text-indigo-500 underline decoration-2 underline-offset-4" href="<?php echo e(route('register')); ?>">
                    <?php echo e(__("Créer un compte client")); ?>
...
<?php endif; ?><?php /**PATH C:\Users\mopao\Application_Web_de_gestion_des_ventes_et_inventaire\resources\views/auth/login.blade.php ENDPATH**/ ?>