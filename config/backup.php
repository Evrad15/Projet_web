...
return [
    ...
    'monitor_backups' => [
        [
            /*
             * Le nom doit correspondre EXACTEMENT à celui défini dans 
             * la section 'destination' -> 'name' vue juste avant.
             */
            'name' => 'mon_erp_stock',

            /*
             * On ne surveille que les disques où l'on enregistre réellement.
             * Si tu n'as pas configuré Amazon, retire 's3'.
             */
            'disks' => ['local'],
            'health_checks' => [
